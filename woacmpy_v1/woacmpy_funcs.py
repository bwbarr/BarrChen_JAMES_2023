...
def set_spray_inputs():
    ...
    if wg.global_UMWM == False:
        wg.spray_inputs = wg.inps_uwincm
    elif wg.global_UMWM == True:
        wg.spray_inputs = wg.inps_umwmglb
    wg.field_info[101][4] = wg.spray_inputs
    wg.field_info[131][4] = wg.spray_inputs
    wg.field_info[161][4] = wg.spray_inputs
    wg.field_info[191][4] = wg.spray_inputs
    wg.field_info[602][4] = wg.spray_inputs
    wg.field_info[650][4] = wg.spray_inputs
